    ...
    return (
      <div className="max-w-4xl mx-auto space-y-8">
        <GlassCard className="p-12 text-center">
          ...
          <Button onClick={() => { if (typeof window !== 'undefined') supabase.auth.signInWithOAuth({ provider: 'google', options: { redirectTo: window.location.origin + window.location.pathname } }); }} className="bg-blue-600 hover:bg-blue-700">
            Login
          </Button>
        </GlassCard>
      </div>
